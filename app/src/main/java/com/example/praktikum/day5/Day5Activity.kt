...
import com.example.praktikum.databinding.ActivityDay5Binding
...
class Day5Activity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityDay5Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDay5Binding.inflate(layoutInflater)
